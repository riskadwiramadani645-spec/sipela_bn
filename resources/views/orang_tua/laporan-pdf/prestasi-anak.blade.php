...
<head>
    <meta charset="utf-8">
    <title>Laporan Prestasi Anak - Orang Tua</title>
    <style>
...
<body>
    <div class="header">
        ...
        <h2>LAPORAN PRESTASI ANAK</h2>
        <p>Generated: {{ now()->setTimezone('Asia/Jakarta')->format('d F Y, H:i:s') }} WIB</p>
        <p>Periode: {{ $periode ?? 'Semua Data' }}</p>
    </div>

    <div class="success">
        <strong>✅ LIMITED ACCESS:</strong> Laporan ini hanya menampilkan data prestasi anak Anda sendiri.
    </div>
    ...
    <div class="section">
        ...
        <table>
            ...
            <tbody>
                ...
                @empty
                <tr>
                    <td colspan="6" style="text-align: center;">Tidak ada data prestasi pada periode ini</td>
                </tr>
                @endforelse
            </tbody>
        </table>
    ...
    <div style="margin-top: 30px;">
        <h4>RINGKASAN:</h4>
        <p>Total Prestasi: {{ count($data ?? []) }} prestasi</p>
        <p>Periode Laporan: {{ $periode ?? 'Semua Data' }}</p>
        <p><strong>Apresiasi untuk Orang Tua:</strong> Selamat! Anak Anda telah menunjukkan prestasi yang membanggakan. Terus dukung dan motivasi anak untuk berprestasi lebih baik lagi.</p>
    </div>
