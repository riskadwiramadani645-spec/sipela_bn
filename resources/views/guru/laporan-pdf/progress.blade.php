...
<head>
    <meta charset="utf-8">
    <title>Laporan Progress Siswa - Guru</title>
    <style>
...
<body>
    <div class="header">
        ...
        <p>Generated: {{ now()->setTimezone('Asia/Jakarta')->format('d F Y, H:i:s') }} WIB | Total: {{ count($data) }} siswa</p>
    </div>
    ...
    <div class="summary">
        ...
        <ul>
            ...
            <li><strong>Siswa Normal:</strong> {{ collect($data)->filter(function($s) { return $s->pelanggaran->count() == 0; })->count() }} siswa</li>
        </ul>
    </div>
